class UI {
  ...
  paint(weather){
    ...
    let timeFormated = `${days[time.getDay()]} ${time.getDate()}th ${months[time.getMonth()]} ${time.getHours()}:${time.getMinutes()}`
    ...
    this.icon.src=`https:${weather.current.condition.icon}`;
    ...
    /// 3-day forecast
    this.forecast1.innerText=days[time.getDay()+1]
    this.forecast2.innerText=days[time.getDay()+2]
    this.forecast3.innerText=days[time.getDay()+3]
    this.fImg1.src=`https:${weather.forecast.forecastday[1].day.condition.icon}`;
    this.fImg2.src=`https:${weather.forecast.forecastday[2].day.condition.icon}`;
    this.fImg3.src=`https:${weather.forecast.forecastday[3].day.condition.icon}`;
